...
public class FeaturedPurchaseController {
    ...
    @PostMapping
    public ResponseEntity<?> buyFeatured(@RequestBody BuyFeaturedRequest request) {
        try {
            var purchase = FEATURED_PURCHASE_SERVICE_IMPL.purchase(request.getInstituteIdentifier());
